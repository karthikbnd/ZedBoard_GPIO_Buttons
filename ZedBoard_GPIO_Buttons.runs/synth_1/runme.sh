...
HD_PWD='C:/Users/kab/Desktop/workspace/ZedBoard_GPIO_Buttons/ZedBoard_GPIO_Buttons.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_led_buttons_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_led_buttons_wrapper.tcl
