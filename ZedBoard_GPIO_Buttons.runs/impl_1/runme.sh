...
HD_PWD='C:/Users/kab/Desktop/workspace/ZedBoard_GPIO_Buttons/ZedBoard_GPIO_Buttons.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_led_buttons_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_led_buttons_wrapper.tcl -notrace
